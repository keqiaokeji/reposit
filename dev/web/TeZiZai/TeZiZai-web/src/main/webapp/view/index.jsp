...
<div class="itemdiv memberdiv">
    <div class="user">
        <img alt="Bob Doe's avatar" src="<%=path%>/bootstrap/assets/avatars/user.jpg"/>
    </div>
...
<div class="itemdiv memberdiv">
    <div class="user">
        <img alt="Joe Doe's avatar" src="<%=path%>/bootstrap/assets/avatars/avatar2.png"/>
    </div>
...
<div class="itemdiv memberdiv">
    <div class="user">
        <img alt="Jim Doe's avatar" src="<%=path%>/bootstrap/assets/avatars/avatar.png"/>
    </div>
...
<div class="itemdiv memberdiv">
    <div class="user">
        <img alt="Alex Doe's avatar" src="<%=path%>/bootstrap/assets/avatars/avatar5.png"/>
    </div>
...
<div class="itemdiv memberdiv">
    <div class="user">
        <img alt="Bob Doe's avatar" src="<%=path%>/bootstrap/assets/avatars/avatar2.png"/>
    </div>
...
<div class="itemdiv memberdiv">
    <div class="user">
        <img alt="Susan's avatar" src="<%=path%>/bootstrap/assets/avatars/avatar3.png"/>
    </div>
...
<div class="itemdiv memberdiv">
    <div class="user">
        <img alt="Phil Doe's avatar" src="<%=path%>/bootstrap/assets/avatars/avatar4.png"/>
    </div>
...
<div class="itemdiv memberdiv">
    <div class="user">
        <img alt="Alexa Doe's avatar" src="<%=path%>/bootstrap/assets/avatars/avatar1.png"/>
    </div>
...
<div id="comment-tab" class="tab-pane">
    <div class="comments">
        <div class="itemdiv commentdiv">
            <div class="user">
                <img alt="Bob Doe's Avatar" src="<%=path%>/bootstrap/assets/avatars/avatar.png"/>
            </div>
        ...
        <div class="itemdiv commentdiv">
            <div class="user">
                <img alt="Jennifer's Avatar" src="<%=path%>/bootstrap/assets/avatars/avatar1.png"/>
            </div>
        ...
        <div class="itemdiv commentdiv">
            <div class="user">
                <img alt="Joe's Avatar" src="<%=path%>/bootstrap/assets/avatars/avatar2.png"/>
            </div>
        ...
        <div class="itemdiv commentdiv">
            <div class="user">
                <img alt="Rita's Avatar" src="<%=path%>/bootstrap/assets/avatars/avatar3.png"/>
            </div>
            ...
            <div class="widget-main no-padding">
                <div class="dialogs">
                    <div class="itemdiv dialogdiv">
                        <div class="user">
                            <img alt="Alexa's Avatar" src="<%=path%>/bootstrap/assets/avatars/avatar1.png"/>
                        </div>
                    ...
                    <div class="itemdiv dialogdiv">
                        <div class="user">
                            <img alt="John's Avatar" src="<%=path%>/bootstrap/assets/avatars/avatar.png"/>
                        </div>
                    ...
                    <div class="itemdiv dialogdiv">
                        <div class="user">
                            <img alt="Bob's Avatar" src="<%=path%>/bootstrap/assets/avatars/user.jpg"/>
                        </div>
                    ...
                    <div class="itemdiv dialogdiv">
                        <div class="user">
                            <img alt="Jim's Avatar" src="<%=path%>/bootstrap/assets/avatars/avatar4.png"/>
                        </div>
...
<script src="<%=path%>/bootstrap/assets/js/jquery.sparkline.min.js"></script>
<script src="<%=path%>/bootstrap/assets/js/flot/jquery.flot.min.js"></script>
